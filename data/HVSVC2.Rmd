...
grep -vEf raw/SampleIds_male.txt consensus_fastas_nonrel.txt > consensus_fastas_nonrel_female.txt
...
grep -vEf raw/SampleIds_male.txt consensus_snv_sv_fastas_nonrel.txt > consensus_snv_sv_fastas_nonrel_female.txt
...
grep -vEf raw/SampleIds_male.txt consensus_snv_indel_fastas_nonrel.txt > consensus_snv_indel_fastas_nonrel_female.txt
...
grep -vEf raw/SampleIds_male.txt consensus_snv_fastas_nonrel.txt > consensus_snv_fastas_nonrel_female.txt
...
grep -vEf raw/SampleIds_male.txt consensus_indel_fastas_nonrel.txt > consensus_indel_fastas_nonrel_female.txt
...
grep -vEf raw/SampleIds_male.txt consensus_sv_fastas_nonrel.txt > consensus_sv_fastas_nonrel_female.txt


```

```{bash step4}
mkdir consensus_autnosomes
for i in ${samples[@]}; do
