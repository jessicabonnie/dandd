...
```
dandd tree --datadir ./assembled-fish_mito --tag fish-mito
...
dandd tree --fastas fish_subset.txt --tag small_fish -k 12
...
```
dandd progressive --dtree small_fish_5_dashing_dtree.pickle --norder 10 
```
...
```
dandd progressive --dtree small_fish_5_dashing_dtree.pickle --norder 30 
```
...
```
dandd kij --dtree small_fish_5_dashing_dtree.pickle
```
...
```
dandd progressive --ksweep --dtree small_fish_progu30_5_dashing_dtree.pickle
```
