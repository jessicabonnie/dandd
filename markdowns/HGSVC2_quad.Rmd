...
#_HG0111|
grep -E "(_HG00513|_HG00514|_HG01114|_NA18534_1)" /scratch16/blangme2/jessica/data/HGSVC2/consensus_fastas.txt > ${filelist}

sketchdir=${outdir}/sketchdb

python ${codelib}/dandd_cmd.py tree -s ${tag} -f ${filelist} -o ${outdir} -k 19 |& tee ${outdir}/${tag}_quad.log

tree_pick=/scratch4/blangme2/jessica/dandd/scratch/HGSVC2/quad_7_dashing_dtree.pickle
