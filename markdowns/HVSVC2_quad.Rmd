...
outdir<-'/home/jbonnie1/scr4_blangme2/jessica/dandd/scratch/HVSVC2'
...
tag=quad
filelist=/data/blangme2/jessica/HVSVC2/consensus_mom_fchild_and_onef_1m1.txt
#_HG0111|
grep -E "(_HG00513|_HG00514|_HG01114|_NA18534_1)" /scratch16/blangme2/jessica/data/HVSVC2/consensus_fastas.txt > ${filelist}

sketchdir=${outdir}/sketchdb

python ${codelib}/dandd_cmd.py tree -s ${tag} -f ${filelist} -o ${outdir} -k 19 |& tee ${outdir}/${tag}_quad.log

tree_pick=/scratch4/blangme2/jessica/dandd/scratch/HVSVC2/quad_7_dashing_dtree.pickle
...
progu <- read.csv('/scratch4/blangme2/jessica/dandd/scratch/HVSVC2/quad_progu5040_7_dashing.csv') %>% mutate(ngenomes=ngen, delta_pos=delta)
...
# delta_quad<-read.csv('/scratch4/blangme2/jessica/dandd/scratch/HVSVC2/quad_progu.csv') %>% 
...
```{r abba, cache=TRUE}
# abba.quad <- read.csv('/scratch4/blangme2/jessica/dandd/scratch/HVSVC2/quad_abba_clean.csv')
...
abba.quad %>% filter(HG00514_1 == 0 & step==3 & HG00513_1 == 1 & HG00513_2 == -1) -> mom1
abba.quad %>% filter(HG00514_1 == 0 & step==3 & (HG00513_1 == 1 | HG00513_2 == 1)) -> allmommy
abba.quad %>% filter(HG00514_1 == 0 & step==3 & HG00513_1 == -1 & HG00513_2 == 1) -> mom2
abba.quad %>% filter(HG00514_1 == 0 & step==3 & HG00513_1 == -1 & HG00513_2 == -1) -> nomommy
...
abba.quad$Mom1_ChildMat <- ifelse(abba.quad$HG00513_1 %in% c(0,1) & abba.quad$HG00514_1 == -1,1,0)
abba.quad$Mom2_ChildMat <- ifelse(abba.quad$HG00513_2 %in% c(0,1) & abba.quad$HG00514_1 == -1,1,0)
abba.quad$Mom_ChildMat <- ifelse((abba.quad$HG00513_1 & abba.quad$HG00513_2) %in% c(0,1) & abba.quad$HG00514_1 == -1,1,0)
abba.quad$ChildMat_Mom1 <- ifelse(abba.quad$HG00514_1 %in% c(0,1) & abba.quad$HG00513_1 == -1,1,0)
abba.quad$ChildMat_Mom2 <- ifelse(abba.quad$HG00514_1 %in% c(0,1) & abba.quad$HG00513_2 == -1,1,0)
abba.quad$ChildMat_Mom <- ifelse((abba.quad$HG00514_1) %in% c(0,1) & (abba.quad$HG00513_1 & abba.quad$HG00513_2) == -1,1,0)

abba.quad$Mom1_ChildPat <- ifelse(abba.quad$HG00513_1 %in% c(0,1) & abba.quad$HG00514_2 == -1,1,0)
abba.quad$Mom2_ChildPat <- ifelse(abba.quad$HG00513_2 %in% c(0,1) & abba.quad$HG00514_2 == -1,1,0)
abba.quad$Mom_ChildPat <- ifelse((abba.quad$HG00513_1 & abba.quad$HG00513_2) %in% c(0,1) & abba.quad$HG00514_2 == -1,1,0)
abba.quad$ChildPat_Mom1 <- ifelse(abba.quad$HG00514_2 %in% c(0,1) & abba.quad$HG00513_1 == -1,1,0)
abba.quad$ChildPat_Mom2 <- ifelse(abba.quad$HG00514_2 %in% c(0,1) & abba.quad$HG00513_2 == -1,1,0)
abba.quad$ChildPat_Mom <- ifelse((abba.quad$HG00514_2) %in% c(0,1) & (abba.quad$HG00513_1 & abba.quad$HG00513_2) == -1,1,0)
```
