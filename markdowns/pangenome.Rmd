...
head ${fasta_list} > ${fasta_list}10

codelib=/scratch16/blangme2/jessica/dandd/dev-dandD/lib
python ${codelib}/dandd_cmd.py tree -s pangenome -f ${overlap_list} --nthreads 20 -k18 -o ${wkdir}
...
python ${codelib}/dandd_cmd.py tree -t hvsvc2_overlap -f ${filelist} --nthreads 20 -k19
